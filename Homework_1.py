...
# if s % (a + b + c) == 0:
#     print('Петя сделал', s / (a + b + c), 'журавликов')
#     print('Сережа сделал', s / (a + b + c), 'журавликов')
#     print('Катя сделала', s / (a + b + c) * (a + b) * 2, 'журавликов')
# else:
#     print('No')
...
# b = a % 1000
# c = a // 1000
# summa1 = b % 10 + (b // 10 ) % 10 + (b // 100) % 10
# summa2 = c % 10 + (c // 10 ) % 10 + (c // 100) % 10
